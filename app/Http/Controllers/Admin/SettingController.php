...
class SettingController extends Controller
{
    ...
    public function WebsiteUpdate(Request $request,$id)
    {
        ...
        //     $logo_name = '.'.$request->file('logo')->getclientOriginalExtension();
        //     $img = $manager->read($request->file('logo'));
        //     $img = $img->resize(320,120)->save('files/setting/'.$logo_name);
        //     $img ='files/setting/'.$logo_name; 
        // }else{
        ...
        if ($request->logo) {  //jodi new logo die thake
              ...
              $logo->move('files/setting/',$logo_name);
        ...
        if ($request->favicon) {  //jodi new logo die thake
              ...
              $favicon->move('files/setting/',$favicon_name);
